...
/***/ 55:
/*!************************************************************************************************************!*\
  !*** /Users/shaoGan/Documents/HBuilderProjects/crmeb_java_git/app/main.js?{"page":"pages%2Fuser%2Findex"} ***!
  \************************************************************************************************************/
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/user/index.vue */ 56));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 56:
/*!*****************************************************************************************!*\
  !*** /Users/shaoGan/Documents/HBuilderProjects/crmeb_java_git/app/pages/user/index.vue ***!
  \*****************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _index_vue_vue_type_template_id_137d5072___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=137d5072& */ 57);
...
/***/ 57:
/*!************************************************************************************************************************!*\
  !*** /Users/shaoGan/Documents/HBuilderProjects/crmeb_java_git/app/pages/user/index.vue?vue&type=template&id=137d5072& ***!
  \************************************************************************************************************************/
...
/***/ 58:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/shaoGan/Documents/HBuilderProjects/crmeb_java_git/app/pages/user/index.vue?vue&type=template&id=137d5072& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var g0 = _vm.userInfo.nowMoney
    ? Number(_vm.userInfo.nowMoney).toFixed(2)
    : null
...
/***/ 59:
/*!******************************************************************************************************************!*\
  !*** /Users/shaoGan/Documents/HBuilderProjects/crmeb_java_git/app/pages/user/index.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 60:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/shaoGan/Documents/HBuilderProjects/crmeb_java_git/app/pages/user/index.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//
//
var authorize = function authorize() {Promise.all(/*! require.ensure | components/Authorize */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/Authorize")]).then((function () {return resolve(__webpack_require__(/*! @/components/Authorize */ 604));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var app = getApp();var _default = { components: { authorize: authorize }, computed: (0, _vuex.mapGetters)(['isLogin']), data: function data() {return { orderMenu: [{ img: '/static/images/order1.png', title: '待付款', url: '/pages/users/order_list/index?status=0', num: 0 }, { img: '/static/images/order2.png', title: '待发货', url: '/pages/users/order_list/index?status=1', num: 0 }, { img: '/static/images/order3.png', title: '待收货', url: '/pages/users/order_list/index?status=2', num: 0 }, { img: '/static/images/order4.png', title: '待评价', url: '/pages/users/order_list/index?status=3', num: 0 }, { img: '/static/images/order5.png', title: '售后/退款', url: '/pages/users/user_return_list/index', num: 0 }], imgUrls: [], userMenu: [], autoplay: true, circular: true, interval: 3000, duration: 500, isAuto: false, //没有授权的不会自动授权
      isShowAuth: false, //是否隐藏授权
      orderStatusNum: {}, userInfo: {}, MyMenus: [], wechatUrl: [] };}, onLoad: function onLoad() {var that = this;that.$set(that, 'MyMenus', app.globalData.MyMenus);}, onShow: function onShow() {var that = this;if (that.isLogin) {this.getUserInfo();this.getMyMenus(); // this.setVisit();
      this.getOrderData();} else {}}, methods: { // 记录会员访问
    // setVisit(){
    // 	setVisit({
    // 		url:'/pages/user/index'
    // 	}).then(res=>{})
    // },
    kefuClick: function kefuClick() {location.href = this.wechatUrl[0].wap_url; // return this.$util.Tips({
      // 	title: '客服功能正在开发中......'
      // });
    }, getOrderData: function getOrderData() {var that = this;(0, _order.orderData)().then(function (res) {that.orderMenu.forEach(function (item, index) {switch (item.title) {case '待付款':item.num = res.data.unPaidCount;break;case '待发货':item.num = res.data.unShippedCount;break;case '待收货':item.num = res.data.receivedCount;break;case '待评价':item.num = res.data.evaluatedCount;break;case '售后/退款':item.num = res.data.refundCount;break;}});that.$set(that, 'orderMenu', that.orderMenu);});}, // 打开授权
    openAuto: function openAuto() {this.isAuto = true;this.isShowAuth = true;}, // 授权回调
    onLoadFun: function onLoadFun() {this.getUserInfo();this.getMyMenus(); // this.setVisit();
      this.getOrderData();}, Setting: function Setting() {uni.openSetting({ success: function success(res) {console.log(res.authSetting);} });}, // 授权关闭
    ...
    /**
        ...
        * 获取个人中心图标
        */
    getMyMenus: function getMyMenus() {var _this = this;
      var that = this;
      ...
      (0, _user.getMenuList)().then(function (res) {
        ...
        // }))
        _this.wechatUrl = res.data.routine_my_menus.filter(function (item) {
          return item.url.indexOf('service') !== -1;
        });
        console.log(_this.wechatUrl);
        _this.imgUrls = res.data.routine_my_banner;
      });
    },
    // 编辑页面
...
/***/ 61:
/*!***************************************************************************************************************************!*\
  !*** /Users/shaoGan/Documents/HBuilderProjects/crmeb_java_git/app/pages/user/index.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 62:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/shaoGan/Documents/HBuilderProjects/crmeb_java_git/app/pages/user/index.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
