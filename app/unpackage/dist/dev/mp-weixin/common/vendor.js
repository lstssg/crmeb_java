...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _app = _interopRequireDefault(__webpack_require__(/*! ./app */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _user = __webpack_require__(/*! ../../api/user.js */ 13);
...
var state = {
  token: _cache2.default.get(_cache.LOGIN_STATUS) || null,
  backgroundColor: "#fff",
  userInfo: null,
  uid: _cache2.default.get(_cache.UID) || null,
  homeActive: false,
  chatUrl: _cache2.default.get('chatUrl') || '' };
...
{
  return _request.default.post("user/spread", { puid: puid });
}
...
/**
   ...
   * 
   */
function getlevelExpList()
{
  return _request.default.get("user/expList");
}
...
function openRechargeSubscribe() {
  var tmplIds = uni.getStorageSync('tempID' + arrTemp[4]);
  return subscribe(tmplIds);
}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _app = __webpack_require__(/*! @/config/app */ 15);





var _login = __webpack_require__(/*! ../libs/login */ 8);
...
params) {var _ref$noAuth = _ref.noAuth,noAuth = _ref$noAuth === void 0 ? false : _ref$noAuth,_ref$noVerify = _ref.noVerify,noVerify = _ref$noVerify === void 0 ? false : _ref$noVerify;
  var Url = _app.HTTP_REQUEST_URL,header = _app.HEADER;
  if (params != undefined) {
...
var josn = __webpack_require__(/*! ../../domain.json */ 16);
var domain = josn.domain;
...
module.exports = JSON.parse("{\"domain\":\"http://localhost:8080\"}");
...

{
  ...
  // 生成海报
  PosterCanvas: function PosterCanvas(arrImages, storeName, price, successFn) {
    uni.showLoading({
      title: '海报生成中',
      mask: true });
  ...
  uploadImageOne: function uploadImageOne(opt, successCallback, errorCallback) {
    ...
    uni.chooseImage({
      ...
      success: function success(res) {
        ...
        var urlPath = _app.HTTP_REQUEST_URL + '/api/front/' + uploadUrl + "?model=" + model + "&pid=" + pid;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getIndexData = getIndexData;exports.getLogo = getLogo;exports.setFormId = setFormId;exports.setCouponReceive = setCouponReceive;exports.getCoupons = getCoupons;exports.getUserCoupons = getUserCoupons;exports.getArticleCategoryList = getArticleCategoryList;exports.getArticleList = getArticleList;exports.getArticleHotList = getArticleHotList;exports.getArticleBannerList = getArticleBannerList;exports.getArticleDetails = getArticleDetails;exports.loginMobile = loginMobile;exports.verifyCode = verifyCode;exports.registerVerify = registerVerify;exports.phoneRegister = phoneRegister;exports.phoneRegisterReset = phoneRegisterReset;exports.phoneLogin = phoneLogin;exports.switchH5Login = switchH5Login;exports.bindingPhone = bindingPhone;exports.logout = logout;exports.getTemlIds = getTemlIds;exports.pink = pink;exports.getCity = getCity;exports.getLiveList = getLiveList;exports.getQrcode = getQrcode;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 14));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
/**
...
{
  return _request.default.get("index", {}, { noAuth: true });
}
...
{
  return _request.default.post('wechat/program/my/temp/list?limit=3&page=1', data, { noAuth: true });
}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getCombinationList = getCombinationList;exports.getCombinationDetail = getCombinationDetail;exports.getCombinationPink = getCombinationPink;exports.postCombinationRemove = postCombinationRemove;exports.getBargainList = getBargainList;exports.getBargainUserList = getBargainUserList;exports.bargainUserCancel = bargainUserCancel;exports.getBargainDetail = getBargainDetail;exports.postBargainStartUser = postBargainStartUser;exports.postBargainStart = postBargainStart;exports.postBargainHelp = postBargainHelp;exports.postBargainHelpPrice = postBargainHelpPrice;exports.postBargainHelpList = postBargainHelpList;exports.postBargainHelpCount = postBargainHelpCount;exports.postBargainShare = postBargainShare;exports.getSeckillIndexTime = getSeckillIndexTime;exports.getSeckillList = getSeckillList;exports.getSeckillDetail = getSeckillDetail;exports.getBargainPoster = getBargainPoster;exports.getCombinationPoster = getCombinationPoster;exports.getBargainUserCancel = getBargainUserCancel;exports.seckillCode = seckillCode;exports.scombinationCode = scombinationCode;exports.getSeckillHeaderApi = getSeckillHeaderApi;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 14));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     * 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     * 所有活动接口 包括：拼团，砍价，秒杀
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     * 
...
function getCombinationList(data) {
  return _request.default.get('combination/list', data, { noAuth: true });
}
...
function postBargainShare(bargainId) {
  return _request.default.post("bargain/share", { bargainId: bargainId });
}
...
function getWechatConfig() {
  return _request.default.get("wechat/config", { url: encodeURIComponent(_wechat.default.signLink()) }, { noAuth: true });
}
...
function wechatAuth(code, spread, login_type) {
  ...
  { code: code, spread_spid: spread, login_type: login_type },
  { noAuth: true });
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.goShopDetail = goShopDetail;function goShopDetail(item, uid) {
  return new Promise(function (resolve) {
    if (item.activityH5 && item.activityH5.type === "1") {
      ...
      uni.navigateTo({
        url: "/pages/activity/goods_bargain_details/index?id=".concat(item.activityH5.id, "&bargain=").concat(uid) });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.isMoney = isMoney;exports.checkPhone = checkPhone; /**
                                                                                                                                       * 验证小数点后两位及多个小数
                                                                                                                                       * money 金额
                                                                                                                                      */
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.silenceBindingSpread = silenceBindingSpread;exports.isWeixin = isWeixin;exports.parseQuery = parseQuery;exports.default = void 0;var _user = __webpack_require__(/*! @/api/user */ 13);
var _cache = _interopRequireDefault(__webpack_require__(/*! @/utils/cache */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/**
   ...
   * @param string cartId
   */
function orderConfirm(cartId, isNew, addAgain, secKill) {
...
/**
   ...
   * 
   */
function getCouponsOrderPrice(data) {
  return _request.default.get('coupons/order', data);
}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 24));var _store = _interopRequireDefault(__webpack_require__(/*! ../store */ 9));
var _login = __webpack_require__(/*! ./login */ 8);
var _public = __webpack_require__(/*! ../api/public */ 37);
var _cache = _interopRequireDefault(__webpack_require__(/*! ../utils/cache */ 18));
var _cache2 = __webpack_require__(/*! ./../config/cache */ 17);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var
          ...
          fail: function fail(res) {
            reject(res);
                ...
                new Promise(function (resolve, reject) {
                  if (_cache.default.has(_cache2.STATE_R_KEY)) {
                    return resolve(_cache.default.get(_cache2.STATE_R_KEY));
                  }
                  uni.login({
                    provider: provider,
                    success: function success(res) {
    ...
    code, data)
    {
      return new Promise(function (resolve, reject) {
        (0, _public.login)(code, data).then(function (res) {
          ...
          _store.default.commit('UPDATE_USERINFO', res.data.user);
          _store.default.commit('LOGIN', { token: res.data.token });
          _store.default.commit('SETUID', res.data.user.uid);
          // Cache.set(EXPIRES_TIME,res.data.expiresTime,time);
          _cache.default.set(_cache2.USER_INFO, res.data.user);
          return resolve(res);
        }).catch(function (res) {
          return reject(res);
        });
...
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} /*
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          update：2020/04/13
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        */
var cfg = __webpack_require__(/*! ./config.js */ 624),
blankChar = cfg.blankChar,
CssHandler = __webpack_require__(/*! ./CssHandler.js */ 625),_wx$getSystemInfoSync =
...
function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} /*
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          update：2020/03/15
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        */
var cfg = __webpack_require__(/*! ./config.js */ 624);var
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _calendar = _interopRequireDefault(__webpack_require__(/*! ./calendar.js */ 718));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.toLogin = toLogin;exports.checkLogin = checkLogin;var _store = _interopRequireDefault(__webpack_require__(/*! ../store */ 9));
var _cache = _interopRequireDefault(__webpack_require__(/*! ../utils/cache */ 18));
...
var _cache2 = __webpack_require__(/*! ./../config/cache */ 17);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
function toLogin(push, pathLogin) {
...
var _modules = _interopRequireDefault(__webpack_require__(/*! ./modules */ 11));
